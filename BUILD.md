...
CAB doit utiliser une version de projet explicite et cohérente entre les artefacts distribués. La version de base actuelle est `0.67.0` pour le broker et le plugin ; le plugin ajoute uniquement un cachebuster Codex à cette version.
